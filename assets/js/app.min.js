...
this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.7",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.7",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return e<c&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(e+g<=a-d)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function recalc_onclick(e){ssc.recalcSource=e,co.XLEW_2_4_2=eeparseFloat(document.getElementById("XLEW_2_4_2").value),co.XLEW_2_5_2=eeparseFloat(document.getElementById("XLEW_2_5_2").value),co.XLEW_2_6_2=eeparseFloat(document.getElementById("XLEW_2_6_2").value),co.XLEW_2_7_2=eeparseFloat(document.getElementById("XLEW_2_7_2").value),co.XLEW_2_10_2=eeparseFloat(document.getElementById("XLEW_2_10_2").value),co.XLEW_2_14_2=eeparseFloat(document.getElementById("XLEW_2_14_2").value),calc(co),void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState?ssc.realtimesync.coUpdate(co,e):void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.wsUrl&&ssc.realtimesync.IsCloseByError&&!ssc.realtimesync.IsErrorMsgDialogShown&&(alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.")||(ssc.realtimesync.IsErrorMsgDialogShown=!0)),document.getElementById("XLEW_2_5_7").value=eedisplayFloatND(co.XLEW_2_5_7,2),document.getElementById("XLEW_2_7_7").value=eedisplayFloatND(co.XLEW_2_7_7,2),document.getElementById("XLEW_2_8_2").value=eedisplayFloatND(co.XLEW_2_8_2,0),document.getElementById("XLEW_2_8_7").value=eedisplayFloatND(co.XLEW_2_8_7,2),document.getElementById("XLEW_2_11_2").value=eedisplayFloatND(co.XLEW_2_11_2,0),document.getElementById("XLEW_2_11_5").value=eedisplayFloat(co.XLEW_2_11_5),document.getElementById("XLEW_2_12_2").value=eedisplayFloatND(co.XLEW_2_12_2,0),document.getElementById("XLEW_2_15_2").value=eedisplayFloatND(co.XLEW_2_15_2,2),document.getElementById("XLEW_2_15_5").value=eedisplayFloat(co.XLEW_2_15_5)}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function round(e,t){if(isFinite(e)&&isFinite(t)){var n=0>e?-1:1,a=Math.abs(e),i=Math.pow(10,t);return n*Math.round(a*i)/i}return NaN}function eeparseFloat(e){e=String(e).replace(eedecreg,".");var t=parseFloat(e);return isNaN(t)?0:t}function eedisplayFloat(e){if(myIsNaN(e))return Number.NaN;var t=String(e);return near0RegExp.test(t)&&(e=round(e,8),t=String(e)),t.replace(/\./g,eedec)}function eedisplayFloatND(e,t){if(myIsNaN(e))return Number.NaN;var n=round(e,t);if(t>0){var a=String(n);if(-1!=a.indexOf("e"))return a;if(-1!=a.indexOf("E"))return a;var i=a.split(".");if(i.length<2){var r="00000000000000".substring(0,t);return i[0].toString()+eedec+r}var r=(i[1].toString()+"00000000000000").substring(0,t);return i[0].toString()+eedec+r}return n}function postcode(){}function TriggerOnchange(e){var t=jQuery.Event("change");$("#"+e).trigger(t)}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,ssc.pendingUploads>0)return alert("Please wait until all attachments have finished uploading."),!1;var t=$(".error").filter(":hiddenByParent").length;if(t>0)return showValidateMessage(ssc.exMsg+" : "+t+(t>1?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;var n=[];$("input:file").each(function(e,t){var a=$(this).data("files");n=n.concat(a)});for(var a=n.length,i=0;a>i;i++)$("#formc").append("<input type='hidden' id='"+["xll_fileid"+i]+"' name='"+["xll_fileid"+i]+"' value='"+n[i].id+"'/>");$("#formc").submit()}function printAllClick(){if(void 0!=ssc.utils){window.ps=!1;var e=ssc.utils.checkIfFileURI();if(e)return void $("#printall-fromfile-modal").modal("show");recalc_onclick(""),$("#printAllTheme").length||$("head").append("<style id='printAllTheme' type='text/css'>@media print{.panel-default .panel-collapse,.tab-content .tab-pane:not(.hide-printsheet){display:block!important}a{color:inherit;text-decoration:none!important}a:link,a:visited{text-decoration:none}body{background:#fff;color:#000;font:11pt}.tab-pane{page-break-after:always}.tab-pane:last-child{page-break-after:auto}.panel-collapse{page-break-after:always!important}.panel-collapse:last-child{page-break-after:auto}.panel-heading,.jw-header{display:none!important}.jw-step{display:block!important;page-break-after:always}.navbar-default{display:none!important;}}</style>"),window.print(),$("#printAllTheme").remove()}else console.log("Printall does not work in file system, please upload your converted page.")}function LoadFromQueryString(){var e=decodeURI(document.location.search),t=!1;e.indexOf("_readonly")>-1&&(t=!0),e.length>0&&$.each(e.substr(1).split("&"),function(e,t){var n=t.split("=");if(2==n.length){var a=n[0].toString(),i=n[1].toString();ssc.formBinder.bind(a,i)}})}function navigate(e){var t=e.keyCode|e.which;if(13==t||40==t||38==t){var n=$(e.target||e.srcElement);if(!n.is("textarea")&&(!n.is("select")||38!=t&&40!=t)){for(var a=parseInt(n.attr("data-sheet"),10),i=parseInt(n.attr("data-row"),10),r=parseInt(n.attr("data-col"),10),s=!1,o=$("#sheet-"+a),l='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',c=i+1,d=i-1,u=c,f=d;40==t&&u>=c||38==t&&d>=f;){var p=o.find(l).filter("[data-sheet="+a+"][data-row="+(38==t?d:c)+"][data-col="+r+"]");if(p.length>0){p.focus(),p.is("input:text, textarea")&&p.select(),s=!0;break}var m;void 0==o.data("col"+r)?(m=o.find(l).filter("[data-sheet="+a+"][data-col="+r+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),o.data("col"+r,m)):m=o.data("col"+r),u=m[m.length-1],f=m[0];var g="indexOf"in Array.prototype?m.indexOf(i):$.inArray(i,m);if(40==t&&u>i)c=m[g+1];else{if(!(38==t&&i>f))break;d=m[g-1]}}if(!s){var _;_=38==t?parseInt(n.attr("tabindex"),10)-1:parseInt(n.attr("tabindex"),10)+1;var y=o.find(l).filter("[data-sheet][data-row][data-col][tabindex="+_+"]");if(y.length>0)y.is(":radio")&&(y=y.filter(":checked")),y.length>0&&(y.focus(),y.is("input:text, textarea")&&y.select());else{var v=o.find(l).filter("[data-sheet][data-row][data-col][tabindex]:first");v.focus(),v.is("input:text, textarea")&&v.select()}}e.preventDefault?e.preventDefault():e.returnValue=!1}}}function calendarCallback(e){var t=$("#"+e.id).data("caltype"),n="popup"==t?e.id:"cal_"+e.id,a=$("#"+n),i=e.s1;void 0===a.data("is-dirty")&&(""==i||isNaN(i)||(a.datepicker("update",new Date(year(i),eemonth(i)-1,eeday(i))),EE.eeRecalcNeeded=!0))}function showValidateMessage(e,t){toastr?t&&t.length>0?toastr.error(e,t):toastr.error(e):alert(e)}function resetClick(){void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&(ssc.realtimesync.connection.close(),ssc.realtimesync.connected=!1,ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))),document.formc.reset(),postcode(),LoadFromQueryString(),recalc_onclick("reset")}var eeisus=0,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=",",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(",","g"),eecurrencyreg=new RegExp("€","g"),eepercentreg=new RegExp("%","g"),co=new Object,near0RegExp=new RegExp("[.](.*0000000|.*9999999)");jQuery.expr[":"].hiddenByParent=function(e){if(e.id.startsWith("xl_"))return!0;var t=!1,n=$(e);return void 0!=n&&(t="none"!=n.closest("tr[class^='_css']").css("display")),1==t&&(t="none"!=n.closest(".tab-pane>div").css("display")),t};var ssccf1n=function(e,t,n,a){switch(e){case"image":$("#"+t).attr("src",$("#"+a).attr("src"))}},ssccf4n=function(e,t,n,a,i,r,s){},ssc=ssc||{};ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="Calculo_Kg_Explosivo html",ssc.exMsg="The fields with the red border are required or invalid.",$(window).on("scroll",function(){var e=$(window);$(".position-fixed-x").css("left",e.scrollLeft()),$(".position-fixed-y").css("top",e.scrollTop())}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",ssc.Dialog.OfflineSubmitWaitCounter="Left";var focused=!1;!function(e){postcode(),ssc.active_sheet_selector="div.active > div.container-fluid.ssc-responsive-sheet > div.row > section",e("a").on("click",function(t){var n=e(this).attr("href");if("#"==n.slice(0,1)){if(t.preventDefault(),"#"==n)return;var a=e(n);if(0==a.length)return void alert("Oops! This link is broken so can not navigate.");focused=!1,ssc.focusOnElement(a)}}),ssc.focusOnElement=function(t){if(!focused){focused=!0;var n=t.parents(".tab-pane");n.hasClass("active")||e('.nav-tabs a[href="#'+n.attr("id")+'"]').tab("show"),e("html, body").stop().animate({scrollTop:t.offset().top-40},900,"swing",function(){t.focus()})}},e(".btn.btn-sm.button-submit.spin-button").on("click",function(){return submitClick(this),!1}),e(".btn.btn-sm.button-reset").on("click",function(){return resetClick(this),!1}),e(".btn.btn-sm.button-update").on("click",function(){return recalc_onclick(""),!1}),e(".btn.btn-sm.button-print.all").on("click",function(){return printAllClick(this),!1});var t=e('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');void 0!=t&&0==t.filter(":first").hasClass("form-control")&&t.filter(":first").focus(),e("textarea[readonly],input[type=text][readonly]").css("background","transparent")}($),ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,t=e.indexOf("MSIE "),n=e.indexOf(".NET CLR");return!(-1===t&&-1===n)};